...
time and energy into improving our code, and recovering from the mistakes we'll
inevitably make. If you want to learn more about improving code internally, without
changing its external behavior (AKA "refactoring"), we recommend that you try out [exercism.io](http://exercism.io/languages/). They have standardised many problem sets
across many programming languages, and you can code your solution against pre-defined
tests.
